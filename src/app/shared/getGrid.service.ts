    ...
    return this.http.get < any > (apiUrl)
      .pipe(
        map(grid => {
          ...
          let mobileQuery = "@media (max-width:800px){.lg-desktop-grid .lg-col{width:100%; }.lg-desktop-grid.lg-grid{padding-top:5vw;padding-bottom:5vw;}.lg-desktop-grid .lg-row{padding-left:5vw;padding-right:5vw;}.lg-desktop-grid .lg-col{margin-bottom:5vw;}.lg-desktop-grid .lg-row:last-child .lg-col:last-child{margin-bottom:0;} }";
